...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    onSnapshot(proRef, (snapshot) => {
      ...
      const proItem = pro.filter((item) => item.slug === slug);
      ...
      <div className="w-full max-w-[1280px] px-[15px] md:px-6  xl:px-8 mx-auto mt-10">
        {product.length > 0 &&
          product.map((pro) => (
            <div
              key={pro.id}
              className="flex flex-col md:grid md:grid-cols-2 md:gap-x-10"
            >
              <div className="flex flex-col lg:flex-row  ">
                <div className=" w-full lg:basis-9/12 ">
                  <img className="w-full object-cover" alt="" src={pro.image} />
                </div>
              </div>
              <div className="body">
                <div className="flex flex-col mt-3 text-base  font-semibold px-2 gap-y-3">
                  ...
                  <div className="flex items-center border border-[#ccc] w-full max-w-[120px] text-base font-medium select-none">
                    ...
                    <span className="px-4 py-2 flex-1 text-center">
                      {number}
                    </span>
                    <div
                      onClick={() => hanldeChange("+")}
                  ...
                  <div className="flex font-medium text-base flex-col">
                    ...
                    <div className="flex text-sm font-normal mt-5 ">
                      <p className="text-justify hidden ">
                        ...
                        trong lòng bàn chân. Đó cũng là nơi bắt đầu của ba “
                        Kinh túc tam âm ” – Tỳ, gan, thận và là nơi cuối cùng
                        của “ Kinh túc tam dương ” – Vị, mật, bàng quang. Bàn
                        chân là gốc của cơ thể, tham gia vào quá trình vận hành
                        khí huyết. Giúp cơ thể tiếp âm hàng ngày trong việc cân
                        bằng cơ thể với trời đất. Giúp nâng đỡ cơ thể vững vàng,
                        di chuyển dễ dàng. Vì vậy có thể chữa bách bệnh thông
                        qua việc tác động vào các huyệt đạo bàn chân Liên hệ với
                        lục phủ ngũ tạng, nối liền các bộ phận quan trọng, các
                        tạng phủ trong cơ thể như tâm (tim) – can (gan) – tỳ
                        (lách) – phế (phổi) – thận đều có các huyệt tương ứng ở
                        bàn chân. Người lớn tuổi, Muối thảo mộc ngâm chân Cung
                        Đình sẽ giúp bạn cải thiện tình trạng này một cách hiệu
                        quả, giúp bạn trị dứt điểm những cơn đau nhức chân, trị
                        mùi khó chịu, giúp bạn có giấc ngủ ngon mỗi đêm.
                      </p>
